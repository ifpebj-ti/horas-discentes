...
export default function Login() {
  ...
  return (
    <div className="min-h-screen grid md:grid-cols-2">
      {/* Imagem no topo (mobile) ou esquerda (desktop) */}
        ...
        <div className="w-full max-w-md">
          ...
          <div className="mb-1">
            ...
            <div className="flex items-center border rounded px-3 py-2 text-sm">
              ...
              {showPassword ? (
                <FiEyeOff
                  className={`ml-2 cursor-pointer ${password ? "text-[#1351B4]" : "text-gray-400"
                    }`}
          ...
          <p className="text-sm text-gray-600 mb-2">Digite sua senha de segurança.</p>
