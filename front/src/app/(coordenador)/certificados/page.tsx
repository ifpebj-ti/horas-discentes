...
export default function ValidacaoCertificadosPage() {
    ...
    const handleReject = () => {
        ...
        setCertificadoSelecionado((prev) =>
            prev ? { ...prev, status: 'rejeitado', motivoRejeicao: motivoRejeicaoInput } : null
        );
    };
    ...
    return (
        <div className="flex flex-col h-screen">
            ...
            <div className="flex-grow flex overflow-hidden">
                {/* LISTA */}
                <div
                    className={`w-full md:w-3/5 lg:w-2/3 p-6 overflow-y-auto ${isMobile && certificadoSelecionado ? 'hidden' : ''
                        }`}
                >
                ...
                {/* DETALHES */}
                <aside
                    className={`w-full md:w-2/5 lg:w-1/3 p-6 bg-gray-50 border-l border-gray-200 overflow-y-auto ${isMobile && !certificadoSelecionado ? 'hidden' : ''
                        }`}
                >
                    {certificadoSelecionado ? (
