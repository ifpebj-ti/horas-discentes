...
import { useCreateSecretariatAccount } from './hooks/useCreateSecretariatAccount';

export const CreateSecretariatAccount = () => {
  const {
  ...
  useEffect(() => {
    ...
    const mockedEmail = 'secretaria@example.com';
...
export default CreateSecretariatAccount;
